...
import com.example.simple.pojo.LoginRequestModel;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
		...
		try {
			userDto = ((UserService)SpringApplicationContext.getBean("userServiceImpl")).getuserDetailsByEmail(userEmail);
		...
		response.addHeader("userName", userDto.getFirstName());
}
}
